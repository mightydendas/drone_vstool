...
public class GameManager : Singleton<GameManager> {
    ...
    private static void OnDomainReload() {
        // Enable() se vola v ArcGISCameraControllerTouch v Awake
        // pri reloadu domeny se nikde z nejakeho duvodu znovu nezavalo a rozbije se vsechno :(
    ...
    private void OnEnable() {
        ...
        WebSocketServer.Instance.ServerRunning += HandleServerRunning;
        WebSocketServer.Instance.ClientConnected += HandleClientConnected;
        WebSocketServer.Instance.ClientDisconnected += HandleClientDisconnected;
    }

    private void Instance_Initialized() {
    ...
    public void OnWebSocketConnected(HelloResponse helloResponse) {
